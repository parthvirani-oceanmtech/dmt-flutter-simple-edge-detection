...
import 'package:simple_edge_detection_example/image_cropper/src/crop_grid.dart';
  ...
  _CornerTypes hitTest(Offset point) {
    for (final gridCorner in gridCorners.entries) {
      final area = Rect.fromCenter(
          center: gridCorner.value, width: 2 * widget.gridCornerSize, height: 2 * widget.gridCornerSize);
